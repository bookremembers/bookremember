    ...
    var has3d,
        ...
        turnMethods = {
            ...
            init: function (options) {
                ...
                _pagesInDOM = options.pagesInDOM;
                // Define constants
            ...
            range: function (page) {
                ...
                if (view[0] >= 1 && view[1] <= data.totalPages) {
                    ...
                    remainingPages = Math.floor((_pagesInDOM - 2) / 2);
                ...
                if (display === undefined) {
                    ...
                    switch (display) {
                        case 'single':
                            ...
                            if (!data.pageObjs[0]) {
                                this.turn('stop').css({'overflow': 'visible'});
                ...
                if (!data.wrapper)
                    switch (data.effect) {
                        ...
                        case 'sheet':
                            ...
                            if (turnData.opts.gradients)
                                data.ashadow = $('<div/>', divAtt(0, 0, 1)).addClass("f_page").appendTo(data.fpage);
